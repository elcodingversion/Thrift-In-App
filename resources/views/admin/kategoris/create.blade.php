...
<div class="create-category-container">
    ...
    <div class="modern-card">
        <div class="card-heading">
            ...
            <p class="card-subtitle">Organisasikan produk menjadi lebih rapi dengan mengelompokkannya sesuai kategori belanja.</p>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.kategoris.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint">
                        <i class="fas fa-info-circle"></i> URL ini digunakan untuk link kategori di toko. Dibuat otomatis saat Anda mengetik nama.
                    </div>
                    @error('slug')
                        <div class="invalid-feedback">
                            <i class="fas fa-exclamation-circle"></i> {{ $message }}
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              id="description" 
                              name="description" 
                              placeholder="Ceritakan dengan singkat barang apa saja yang akan masuk ke kategori ini... (Opsional)">{{ old('description') }}</textarea>
                    <div class="form-hint">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-submit">
                        <i class="fas fa-check"></i> Simpan Kategori
                    </button>
                </div>
            </form>
        </div>
